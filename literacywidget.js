...
LiteracyWidget.prototype._getValues = function() {
    ...
    if (finishCount && this.timer.elapsed) {
        finishWpm = finishCorrect * 60 / this.timer.elapsed;
    }
    ...
    return {
        ...
        finishWordsPerMinute: Math.round(finishWpm),
        finishTime: this.timer.elapsed,
        finishPercentageCorrect: Math.round(finishCorrect * 1000 / finishCount) / 10,
